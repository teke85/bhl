  ...
  const keyPrinciples = [
    {
      ...
      description: "Delivering infrastructure that meets and exceeds international standards",
    },
    {
      title: "Stakeholder Engagement",
      description: "Maintaining open dialogue with communities, partners, and government",
    },
    {
      title: "Sustainable Practices",
      description: "Implementing environmentally responsible construction methods",
    },
    {
      title: "Long-term Vision",
      description: "Building for generations to come with durable, resilient infrastructure",
    },
  ];
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <p className="text-lg md:text-xl text-foreground dark:text-white leading-relaxed mb-8">
              ...
              transformative infrastructure initiative that strengthens
              Zambia&apos;s regional connectivity, economic resilience, and
              social equity. Through Barotse Highway Limited, our dedicated
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              <div className="p-6 bg-card dark:bg-[#1a1a1a] rounded-lg border border-border dark:border-white/10">
                ...
                <p className="text-[#868584] dark:text-gray-300">
                  We provide regular updates to stakeholders on project progress,
                  financial performance, and social and environmental impacts.
                </p>
              </div>
              ...
              <div className="p-6 bg-card dark:bg-[#1a1a1a] rounded-lg border border-border dark:border-white/10">
                ...
                <p className="text-[#868584] dark:text-gray-300">
                  We actively engage with local communities, government entities,
                  and partners to ensure alignment and address concerns promptly.
                </p>
              </div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-[#868584] dark:text-gray-300 mb-8">
              Discover how we're making a difference across the Western Corridor
            </p>
