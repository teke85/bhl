    ...
    <main className="min-h-screen bg-black">
      <div className="w-full mx-auto">
        <HeroCarousel
          ...
          backgroundImage={
            data.heroBackgroundImage?.node?.sourceUrl || "/placeholder.svg"
          }
        ...
        <KeyStatsUpdated
          ...
          mainTitle={
            data?.keystatsmaintitle
              ? stripHtml(data.keystatsmaintitle)
              : "OUR KEY STATS"
          }
        />
        ...
        <SectionWrapper>
          <ExpertBuildersSection
            ...
            regionalButton2Link={
              data.expertBuildersButton2Link || "/regional-impact"
            }
          />
        </SectionWrapper>
        ...
        <ProjectMilestonesSection
          ...
          buttonText={
            data?.projectMilestonesButtonText
              ? stripHtml(data.projectMilestonesButtonText)
              : undefined
          }
        ...
        <CommunityFirstSection
          title={
            data?.communityfirstSectionTitle
              ? stripHtml(data.communityfirstSectionTitle)
              : undefined
          }
          paragraph={
            data?.sectionParagraph
              ? stripHtml(data.sectionParagraph)
              : undefined
          }
          buttonText={
            data?.ctaButtonText ? stripHtml(data.ctaButtonText) : undefined
          }
        ...
        <PartnersCarousel
          title={
            data?.partnersTitle ? stripHtml(data.partnersTitle) : undefined
          }
          subtitle={
            data?.partnersSubtitle
              ? stripHtml(data.partnersSubtitle)
              : undefined
          }
          description={
            data?.partnersDescription
              ? stripHtml(data.partnersDescription)
              : undefined
          }
          partners={partners.length > 0 ? partners : undefined}
          buttonText={
            data?.ctaButtonTextReadmore
              ? stripHtml(data.ctaButtonTextReadmore)
              : undefined
          }
