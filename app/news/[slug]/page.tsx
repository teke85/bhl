          ...
          >
            ...
            <article
              className="
                ...
                prose-ul:text-[#4a4a4a] 
                dark:prose-ul:text-gray-300
                prose-ul:leading-relaxed 
                prose-ul:mb-6
                prose-ol:text-[#4a4a4a] 
                dark:prose-ol:text-gray-300
                prose-ol:leading-relaxed 
                prose-ol:mb-6
                prose-li:mb-2 
                prose-li:pl-2
                prose-li:marker:text-[#fdb913]
                prose-blockquote:border-l-4 
                prose-blockquote:border-[#fdb913]
                prose-blockquote:bg-card 
                dark:prose-blockquote:bg-[#1a1a1a]
                ...
                prose-thead:bg-card 
                dark:prose-thead:bg-[#1a1a1a]
                prose-thead:border-b-2 
                prose-thead:border-[#fdb913]
                prose-th:px-4 
                prose-th:py-3 
                prose-th:text-left 
