          ...
          >
            ...
            <article
              className="
                                ...
                                prose-h2:text-3xl prose-h2:mb-5 prose-h2:mt-10 prose-h2:border-b prose-h2:border-border dark:prose-h2:border-white/10 prose-h2:pb-3
                                prose-h3:text-2xl prose-h3:mb-4 prose-h3:mt-8
                                prose-h4:text-xl prose-h4:mb-3 prose-h4:mt-6
                                
                                /* Paragraphs */
                                prose-p:text-[#4a4a4a] dark:prose-p:text-gray-300
                                prose-p:leading-[1.8] prose-p:mb-6 prose-p:text-[17px]
                                
                                /* Links */
                                prose-a:text-[#fdb913] prose-a:font-medium prose-a:no-underline
                                hover:prose-a:text-[#e5a711] hover:prose-a:underline
                                ...
                                /* Lists */
                                prose-ul:text-[#4a4a4a] dark:prose-ul:text-gray-300
                                prose-ul:leading-relaxed prose-ul:mb-6
                                prose-ol:text-[#4a4a4a] dark:prose-ol:text-gray-300
                                prose-ol:leading-relaxed prose-ol:mb-6
                                prose-li:mb-2 prose-li:pl-2
                                marker:prose-ul:text-[#fdb913]
                                marker:prose-ol:text-[#fdb913] marker:prose-ol:font-semibold
                                
                                /* Blockquotes */
                                prose-blockquote:border-l-4 prose-blockquote:border-[#fdb913]
                                prose-blockquote:bg-card dark:prose-blockquote:bg-[#1a1a1a]
                                prose-blockquote:py-4 prose-blockquote:px-6 prose-blockquote:my-8
                                prose-blockquote:rounded-r-lg prose-blockquote:italic
                                prose-blockquote:text-[#4a4a4a] dark:prose-blockquote:text-gray-300
                                prose-blockquote:shadow-md
                                
                                /* Images */
                                prose-img:rounded-xl prose-img:shadow-lg prose-img:my-8
                                prose-img:border prose-img:border-border dark:prose-img:border-white/10
                                
                                /* Figures */
                                prose-figcaption:text-center prose-figcaption:text-sm
                                prose-figcaption:text-[#868584] dark:prose-figcaption:text-gray-400
                                prose-figcaption:mt-3 prose-figcaption:italic
                                
                                /* Code */
                                prose-code:text-[#fdb913] prose-code:bg-card dark:prose-code:bg-[#1a1a1a]
                                prose-code:px-2 prose-code:py-1 prose-code:rounded
                                prose-code:text-sm prose-code:font-mono
                                prose-code:before:content-[''] prose-code:after:content-['']
                                
                                prose-pre:bg-[#1a1a1a] prose-pre:border
                                prose-pre:border-white/10 prose-pre:rounded-xl
                                prose-pre:my-6 prose-pre:shadow-lg
                                
                                /* Tables */
                                prose-table:border-collapse prose-table:w-full prose-table:my-8
                                prose-thead:bg-card dark:prose-thead:bg-[#1a1a1a]
                                prose-thead:border-b-2 prose-thead:border-[#fdb913]
                                prose-th:px-4 prose-th:py-3 prose-th:text-left prose-th:font-semibold
                                prose-td:px-4 prose-td:py-3 prose-td:border-b
                                prose-td:border-border dark:prose-td:border-white/10
