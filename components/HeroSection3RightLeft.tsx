...
function HeroCarousel() {
  ...
  useEffect(() => {
    ...
    // Create infinite loop animation - RIGHT TO LEFT
    const animate = () => {
      const startX = window.innerWidth; // Start from the right edge
      const endX = -textWidth; // End off-screen to the left
      ...
      const animateFrame = (timestamp: number) => {
        ...
        const currentX = startX - distance * progress; // Move from right to left
  ...
  // Content animations using CSS transitions and transforms - RIGHT TO LEFT
  useEffect(() => {
  ...
  return (
    <div className="relative h-screen w-full overflow-hidden">
      ...
      {/* Infinite Scrolling "TRANSFORMATION" Text - RIGHT TO LEFT */}
