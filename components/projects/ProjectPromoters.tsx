  ...
  const promoters = [
    {
      ...
      expertise:
        "Mining operations with significant equity injection and traffic guarantee",
    },
    {
      icon: Building2,
      ...
      expertise:
        "Mining to general cargo logistics with specialist expertise in goods movement",
    },
  ];
      ...
      <div className="container mx-auto max-w-7xl">
        <div className="text-center mb-12">
          ...
          <p className="text-lg md:text-xl text-muted-foreground dark:text-[#9ca3af] font-paragraph max-w-3xl mx-auto">
            Leading organizations driving the success of this transformative
                  ...
                  <div className="lg:w-2/3 space-y-6">
                    ...
                    <div className="bg-[#fdb913]/5 border border-[#fdb913]/20 rounded-lg p-4">
                      <p className="text-sm md:text-base text-foreground dark:text-white font-paragraph">
                        <span className="font-semibold text-[#fdb913]">
                          Expertise:
                        </span>{" "}
                        {promoter.expertise}
                      </p>
