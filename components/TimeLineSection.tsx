...
<<<<<<< HEAD
    description: "Comprehensive environmental and social impact assessment completed with community consultations.",
=======
    description:
...
<<<<<<< HEAD
    description: "Technical specifications finalized and construction permits obtained from relevant authorities.",
=======
    description:
...
<<<<<<< HEAD
    description: "Official groundbreaking ceremony and mobilization of construction teams and equipment.",
=======
    description:
...
<<<<<<< HEAD
    description: "Mutanda-Kasempa section (180km) completed and opened for limited traffic.",
=======
    description:
...
<<<<<<< HEAD
    description: "Entire 371km highway completed with toll operations and maintenance systems active.",
=======
    description:
...
<<<<<<< HEAD
    description: "25-year concession period ensuring world-class highway standards and continuous improvements.",
    status: "upcoming",
    phase: "Operations",
  },
]
...
<<<<<<< HEAD
          <h2 className="text-3xl lg:text-4xl font-bold text-foreground mb-4">Project Journey</h2>
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            From conception to completion, track the major milestones of Zambia&apos;s most ambitious infrastructure project
=======
          <h2
            ref={titleRef}
