...
const highlights = [
  {
    ...
    description: "Achieved preferred bidder status from the Road Development Agency",
    date: "June 2024",
            ...
            return (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <h3 className="text-lg font-heading font-bold text-foreground dark:text-white mb-2">{item.title}</h3>
                  <p className="text-sm text-muted-foreground dark:text-gray-400 font-paragraph mb-3">
                    {item.description}
                  </p>
                  <p className="text-xs font-bold text-[#fdb913]">{item.date}</p>
                </div>
              </div>
            )
          })}
