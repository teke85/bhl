...
const phases = [
  ...
  },
  {
    ...
    items: [
      "PPP proposal submitted",
      "Preferred bidder status granted",
      "SPV incorporation",
    ],
    image:
            ...
            >
              <div className="relative h-48 overflow-hidden">
                ...
                <div className="absolute bottom-4 left-4 right-4">
                  <p className="text-sm font-bold text-[#fdb913] uppercase tracking-wide">
                    {phase.phase}
                  </p>
              ...
              <div className="p-8">
                ...
                <p className="text-muted-foreground dark:text-gray-400 font-paragraph mb-6">
                  {phase.description}
                </p>
