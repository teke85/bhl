      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-transparent">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex h-20 items-center justify-between">
            ...
            <button
              onClick={toggleMenu}
              className="flex items-center space-x-3 text-white hover:text-gray-300 transition-colors duration-300 group"
            >
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex-1 overflow-y-auto p-6">
            <nav className="space-y-2">
              ...
              <div ref={addToRefs}>
                <Link
                  href="/"
                  onClick={toggleMenu}
                  className="flex items-center py-4 px-4 text-lg font-medium text-gray-900 hover:bg-gray-700 hover:text-white rounded-lg transition-all duration-300"
                >
                  Home
                </Link>
              </div>
            ...
            <div ref={addToRefs} className="mt-8 pt-6 border-t border-gray-100">
              <Button
                onClick={toggleMenu}
                className="w-full bg-gray-700 hover:bg-gray-800 text-white font-medium py-4 text-lg"
              >
