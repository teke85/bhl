    ...
    const principles = [
        {
            ...
            description: "Informed of their rights and options regarding resettlement",
        },
        {
            number: "2",
            title: "Consultation & Alternatives",
            description: "Consulted and provided with feasible resettlement and compensation alternatives",
        },
        {
            number: "3",
            title: "Full Compensation",
            description: "Promptly compensated at full replacement cost for their losses",
        },
        {
            number: "4",
            title: "Livelihood Restoration",
            description: "Supported to restore or improve their livelihoods and living standards",
        },
        {
            number: "5",
            title: "Vulnerable Protection",
            description: "Special attention given to vulnerable groups and their specific needs",
        },
        {
            number: "6",
            title: "Grievance Mechanism",
            description: "Access to fair and transparent grievance redressal mechanisms",
        },
    ]
                        ...
                        >
                            <div className="flex items-start gap-4">
                                <div className="w-12 h-12 rounded-full bg-[#fdb913] flex items-center justify-center flex-shrink-0">
                                    <span className="text-black font-heading font-bold text-lg">{principle.number}</span>
                                </div>
                                <div>
                                    <h3 className="text-lg font-heading font-bold text-foreground dark:text-white mb-2">
                                        {principle.title}
                                    </h3>
                                    <p className="text-sm text-muted-foreground dark:text-gray-400">{principle.description}</p>
                                </div>
                            </div>
                        </div>
                    ))}
