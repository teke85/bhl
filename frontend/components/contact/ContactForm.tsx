    ...
    return (
        ...
        >
            ...
            <div className="space-y-6">
                ...
                {/* Email Field */}
                <motion.div variants={itemVariants}>
                    <label className="block text-sm font-semibold text-foreground dark:text-white mb-2">Email Address</label>
                    <input
                        type="email"
                        name="email"
                ...
                {/* Phone Field */}
                <motion.div variants={itemVariants}>
                    <label className="block text-sm font-semibold text-foreground dark:text-white mb-2">Phone Number</label>
                    <input
                        type="tel"
                        name="phone"
                ...
                {/* Subject Field */}
                <motion.div variants={itemVariants}>
                    <label className="block text-sm font-semibold text-foreground dark:text-white mb-2">Subject</label>
                    <select
                        name="subject"
